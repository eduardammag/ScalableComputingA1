...
\begin{figure}[H]
    \hspace{-1cm}
    \includegraphics[width=1.15\linewidth]{_Fluxograma(atualizado).png}
...
\begin{itemize}
    \item \textbf{T1 - geral:} O tratador 1 é responsável por eliminar duplicatas, colunas e linhas majoritariamente nulas. Ele recebe um dataframe vindo do extrator e retorna um dataframe para o tratador 2.
...
\begin{itemize}
    ...
    \item \textbf{Análise 4: [Título a definir]} \\
    \textit{Espaço reservado para descrição da quarta análise.}

    \item \textbf{Análise 5: [Título a definir]} \\
    \textit{Espaço reservado para descrição da quinta análise.}
\end{itemize}
